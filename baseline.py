...
class StockPredictor:
    ...
    def predict(self, stock_data: str, symbol: str = "", search_date: str = "") -> Dict:
        ...
        # crowd_agents 병렬 실행 (max_workers=10으로 제한)
        crowd_results = []
...
if __name__ == "__main__":
    ...
    # ========== 설정 구간 (사용자가 수정할 부분) ==========
    CSV_PATH = "data/articles/csv/news_with_article_body_cleaned.csv"
    ...
    # --- 5. 각 이벤트에 대해 예측 실행 ---
    periods = ["day_1", "day_3", "day_7", "day_15", "day_30"]
    success_count = len([e for e in completed_events if e in events])
    fail_count = 0
